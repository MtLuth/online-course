    ...
    >
      ...
      >
        <Stack
          ...
          sx={{ width: '100%' }}
        >
          <Stack spacing={3} textAlign={{ xs: 'center', md: 'left' }} maxWidth={{ md: '50%' }}>
            ...
            <Typography sx={{ color: 'text.secondary', mt: 3, mb: 5 }}>
              Khám phá các khóa học trực tuyến miễn phí từ những chuyên gia hàng đầu, giúp bạn
              nâng cao kỹ năng và kiến thức trong mọi lĩnh vực.
            </Typography>
            ...
            >
              {SUMMARY.map((item) => (
                <Stack key={item.value} spacing={0.5} sx={{ position: 'relative' }}>
                  ...
                  />
                  <Typography variant="h3">{formatNumber(item.value)}+</Typography>
